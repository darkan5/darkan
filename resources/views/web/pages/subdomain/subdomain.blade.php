			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="btn-group pull-right">
						...
						{{--TODO: Zrobić obsługę przycisków --}}

						{{--<button class="btn btn-default plustext">+</button>--}}
						{{--<button class="btn btn-default minustext">-</button>--}}
						{{--<button class="btn btn-default change-contrast">{{ Lang::get('portal.contrast') }}</button>--}}
...
<script type="text/javascript" src="{{ asset('/js/modules/fonts/change_fonts.js') }}"></script>
