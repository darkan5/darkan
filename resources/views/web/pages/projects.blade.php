...
@section('title')
{{ Lang::get('projects.title') }}
@stop

@section('description')
{{ Lang::get('projects.description') }}
@stop
...
<link href="{{ asset('/css/windows/new_project.css') }}" rel="stylesheet">
<link href="{{ asset('/css/windows/new_folder.css') }}" rel="stylesheet">
<link href="{{ asset('/css/windows/upload_zbit.css') }}" rel="stylesheet">
<link href="{{ asset('/css/windows/share_project.css') }}" rel="stylesheet">
<link href="{{ asset('/css/windows/limit_projects.css') }}" rel="stylesheet">
<link href="{{ asset('/css/windows/download_zbit.css') }}" rel="stylesheet">

<!-- POPUPS CSS -->
<link href="{{ asset('/css/popups/popups.css') }}" rel="stylesheet">
		...
		<div class="thumbnail visible">
			...
			<div class="caption">
				...
				<p class="options-container text-center">
				    <span class="btn btn-xs project-button"><a href="{{url('/editor/')}}/<%-project_id%>"><?=Lang::get('utils.open')?></a></span>
...
<script id="window-limit-projects-template" type="text/template">
	...
	<div class="window-content without-topbar">
		...
		<div class="text-center">
			<a target="_blank" class="btn btn-success" href="{{ url('/pricing') }}"><?=Lang::get('projects.projectsLimitLink')?></a>
			<a target="_blank" class="btn btn-info" href="{{ url('/profile') }}"><?=Lang::get('projects.projectsProfileLink')?></a>
		</div>
...
<script type="text/template" src="{{ asset('/js/modules/projects/templates/projectlist_templates.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('/js/modules/windows/new_project/models/new_project_window_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/windows/new_project/views/new_project_window_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/windows/new_folder/models/new_folder_window_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/windows/new_folder/views/new_folder_window_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/windows/upload_zbit/models/upload_zbit_window_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/windows/upload_zbit/views/upload_zbit_window_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/windows/share_project/models/share_project_window_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/windows/share_project/views/share_project_window_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/windows/limit_projects/models/limit_projects_window_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/windows/limit_projects/views/limit_projects_window_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/windows/download_zbit/models/download_zbit_window_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/windows/download_zbit/views/download_zbit_window_view.js') }}"></script>
...
<!-- POPUPS -->
<script type="text/javascript" src="{{ asset('/js/modules/popups/popup/models/popup_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/popups/popup/views/popup_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/popups/delete_folder/views/delete_folder_popup_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/popups/delete_project/views/delete_project_popup_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/popups/error/views/error_popup_view.js') }}"></script>

<script src="{{ asset('/js/modules/popups/factory/popups_factory.js') }}"></script>

<!-- PROJECT LIST -->
<script type="text/javascript" src="{{ asset('/js/modules/projects/models/projectlist_item_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/models/project_item_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/models/folder_item_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/models/share_user_item_model.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/collections/folders_collection.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/collections/projects_collection.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/projectlist_item_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/folders/folder_item_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/folders/normal/normal_folder_item_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/projects/project_item_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/projects/normal/normal_project_item_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/projects/template/template_project_item_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/projects/shared_to_user/shared_to_user_project_item_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/share/share_user_item_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/share/normal/normal_share_user_item_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/share/noexist/no_exist_share_user_item_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/breadcrumb/breadcrumb_item_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/breadcrumb/normal/normal_breadcrumb_item_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/breadcrumb/search/search_breadcrumb_item_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/tree/tree_item_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/items/tree/normal/normal_tree_item_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/factory/folders_factory.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/factory/projects_factory.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/factory/breadcrumbs_factory.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/factory/tree_factory.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/factory/share_user_factory.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/models/projectlist_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/projectlist_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/breadcrumb_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/tree_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/projects_navigation.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/models/summary_model.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/summary_view.js') }}"></script>
<script type="text/javascript" src="{{ asset('/js/modules/projects/views/search_view.js') }}"></script>

<script type="text/javascript" src="{{ asset('/js/modules/projects/controller/project_list_controller.js') }}"></script>
<script type="text/javascript">


	_log('FS', '{!! $foldersStructure !!}');
	var foldersStructureFromDb = {!! $foldersStructure !!};
