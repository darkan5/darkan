        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <a href="{{ url('distributor/changeuserslisttoday') }}" class="btn btn-danger">Dzisiaj</a>
                    <a href="{{ url('distributor/changeuserslistlastweek') }}" class="btn btn-danger">Poprzedni tydzień</a>
                    <a href="{{ url('distributor/changeuserslistweek') }}" class="btn btn-danger">Ten tydzień</a>
                    <a href="{{ url('distributor/changeuserslistlastmonth') }}" class="btn btn-danger">Poprzedni miesiąc</a>
                    <a href="{{ url('distributor/changeuserslistmonth') }}" class="btn btn-danger">Ten miesiąc</a>
                    <a href="{{ url('distributor/changeuserslistyear') }}" class="btn btn-danger">Ten rok</a>

                    <hr>
                    
                    {!! Form::open(array('class' => 'form', 'method' => 'post', 'url' => 'distributor/changesale')) !!}
