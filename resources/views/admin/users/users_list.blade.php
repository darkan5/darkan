                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('admin/userplanslist') . '/' . $user->id}}" class="btn btn-success">Plany</a>

                                <a href="{{ url('admin/user') . '/' . $user->id}}" class="btn btn-warning">Szczegóły</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('Rola') !!}
                        {!! Form::select('role_id', $createRolesList, null, array('class' => 'form-control')) !!}
                    </div>
