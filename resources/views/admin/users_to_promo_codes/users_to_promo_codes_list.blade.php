    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading panel-big">
                <span>Użytkownicy i kody promocyjne</span>
                <div class="btn-group pull-right">
                    ...
                    <a class="btn btn-warning" href="{{ url('admin/userspartnerslist') }}">Lista partnerów</a>
                    <a class="btn btn-info" href="{{ url('admin/userslist') }}">Lista użytkowników</a>
                    <a class="btn btn-default" href="{{ url('admin/promocodeslist') }}">Lista kodów promocyjnych</a>
                </div>
            </div>
...
<script src="{{ asset('/js/roles/admin/users_to_promo_codes_list.js') }}"></script>
