        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <a href="{{ url('partner/changeuserslisttoday') }}" class="btn btn-success">Dzisiaj</a>
                    <a href="{{ url('partner/changeuserslistlastweek') }}" class="btn btn-success">Poprzedni tydzień</a>
                    <a href="{{ url('partner/changeuserslistweek') }}" class="btn btn-success">Ten tydzień</a>
                    <a href="{{ url('partner/changeuserslistlastmonth') }}" class="btn btn-success">Poprzedni miesiąc</a>
                    <a href="{{ url('partner/changeuserslistmonth') }}" class="btn btn-success">Ten miesiąc</a>
                    <a href="{{ url('partner/changeuserslistyear') }}" class="btn btn-success">Ten rok</a>

                    <hr>
                    
                    {!! Form::open(array('class' => 'form', 'method' => 'post', 'url' => 'partner/changesale')) !!}
                    ...
                    {!! Form::submit('Zmień datę raportu', array('class'=>'btn btn-success')) !!}
                    {!! Form::close() !!}
...
<script src="{{ asset('/js/partner_saled_reaport.js') }}"></script>
