...
<h1 class="page-header"><i class="fa fa-users fa-fw"></i> <?=Lang::get("darkanpanel.page_name_users_mailing")?></h1>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn btn-default">
                                    ...
                                    @if($user->fb_link != '')
                                        <a class="btn btn-primary btn-xs" title="{{ $user->fb_link }}" href="{{ $user->fb_link }}">Fb</a>
                                    @endif
                                </div>                    
                            </td>
...
<div class="modal fade" id="add-user-to-group-window" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(array('class' => 'form', 'method' => 'post', 'url' => '/lms/mailing/groupuser')) !!}
...
<div class="modal fade" id="delete-user-from-group-window" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(array('class' => 'form', 'method' => 'delete', 'url' => '/lms/mailing/groupuser')) !!}
            {!! Form::hidden('id_user', null) !!}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('fb_link', 'Facebook link', array('class' => 'control-label')) !!}
