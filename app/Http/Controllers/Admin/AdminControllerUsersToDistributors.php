...
class AdminControllerUsersToDistributors extends AdminController
{
	protected $redirectTo = 'admin/usersdistributorslist';
    ...
    public function getUsersList(){
        ...
        return view('admin.users_distributors.users_distributors_list')
		        		->with('users', $users)
