...
use App\Modules\Mailer\DistributionMail;
use App\Modules\Models\ShareNoExist;
use App\Modules\Models\Share;
use App\Modules\User\UserRepository;

class DistributorUserRepository extends UserRepository {
    ...
    public function createUser($data, $roleId = 6)
    {
    ...
    protected function getRegistrationPlanId() {
        return 14; //plan dla dystrybutora na 5 lat
    } 
