...
use App\Modules\Mailer\ReselerMail;
use App\Modules\Models\ShareNoExist;
use App\Modules\Models\Share;
use App\Modules\User\UserRepository;

class ReselerUserRepository extends UserRepository {
    ...
    public function createUser($data, $roleId = 9)
    {
    ...
    protected function getRegistrationPlanId() {
        return 13; //plan dla reselere na 5 lat
    }
