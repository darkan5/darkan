PageSoundFileUploader = function(){
    this.type = "pagesound";
}

PageSoundFileUploader.prototype = new FileUploader();

PageSoundFileUploader.prototype.sendFile = function( properties ){
...
PageSoundFileUploader.prototype.sendBinaryPart = function( imageData, pageID ){

    DataAccess.uploadPageSoundProgress(pageID, { 'data' : imageData, actionkey:pageID, isDeleted:this.componentIsDeleted() });
}


PageSoundFileUploader.prototype.onComplete = function( data ){
