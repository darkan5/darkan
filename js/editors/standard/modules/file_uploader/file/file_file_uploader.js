FileFileUploader = function(){
    this.type = "file";
}

FileFileUploader.prototype = new FileUploader();

FileFileUploader.prototype.sendFile = function( properties ){
...
FileFileUploader.prototype.sendBinaryPart = function( imageData, actionkey ){

    DataAccess.uploadFileProgress(actionkey, { 'data' : imageData, actionkey:actionkey, isDeleted:this.componentIsDeleted() });
}


FileFileUploader.prototype.onComplete = function( data ){
