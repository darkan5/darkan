VideoFileUploader = function(){
    this.type = "video";
}

VideoFileUploader.prototype = new FileUploader();

VideoFileUploader.prototype.sendFile = function( properties ){
...
VideoFileUploader.prototype.sendBinaryPart = function( imageData, actionkey ){

    DataAccess.uploadVideoProgress(actionkey, { 'data' : imageData, actionkey:actionkey, isDeleted:this.componentIsDeleted() });
}


VideoFileUploader.prototype.onComplete = function( data ){
