var StartingNewpageWindowView = NewpageWindowView.extend({

    tagName: 'div',
    className : 'window window-starting-newpage-view',

    template: _.template($('#window-starting-newpage-template').html()),
    ...
    //             var src = appLink + 'projects/' + userId + '/' + projectId + '/pre/exported_view/' + pageId + '/pagethumb.jpg' + r;
