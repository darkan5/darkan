var AsignUsersToGroupView = PageView.extend({
    template: '#assign-user-to-group-template',
    ...
    initialize: function(data) {
        ...
        this.model = new AssignUsersToGroupModel({groupId: this.groupId});
    ...
    selectUserToAssign: function(e) {
        ...
        _log('this.selectedUsers', this.selectedUsers)
