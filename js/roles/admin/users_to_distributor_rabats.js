var BodyView = Backbone.View.extend({
    ...
    events: {
        'click .edit-user-to-distributor-rabat' : 'editUserToDistributorRabat',
        'click .delete-user-to-distributor-rabat' : 'deleteUserToDistributorRabat',
    },
    ...
    editUserToDistributorRabat: function(e) {
        ...
        var windowBootstrap = $('#edit-user-to-distributor-rabat-window');



        windowBootstrap.find('input[name="user_to_distributor_rabat_id"]').val(sender.attr('user_to_distributor_rabat_id'));
    ...
    deleteUserToDistributorRabat: function(e) {
        ...
        var windowBootstrap = $('#delete-user-to-distributor-rabat-window');
