    ...
    renderFolderStructure: function(folderModel){
        ...
        if(this.searchValue != ''){
            ...
            if (this.itemsCollection.length == 0) {
                this.$el.find('.projects-container').html('<div class="noprojects-info"><span class="addproject">'+ Lang.get('projects.noprojectsInfo') +'</span></div>')
            }
