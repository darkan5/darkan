...
<?php echo e(Lang::get('frontpage.PAGE_TITLE')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('description'); ?>
<?php echo e(Lang::get('frontpage.PAGE_DESCRIPTION')); ?>
...
<script type="text/javascript">
	var videoId = '<?php echo e(Lang::get('frontpage.videoId')); ?>';
</script>
...
<div class="movie-container">
	...
	?>
		...
		<?php if(!$mobile): ?>
			...
			<img src="<?php echo e(asset('/css/img/frontpage/background.jpg')); ?>">
	...
	<div class="col-lg-10 text-center frontpage-welcome">
		...
		<div class="row test-drive-row">
			...
			<a href="<?php echo e(url('/testdrive')); ?>" class="test-drive">
	...
	<div class="text-center margin20-0">
		<ul class="trusted-us-logos">
			<li>
				<img src="<?php echo e(asset('/css/img/frontpage/trustedus/bosh.png')); ?>" alt="Bosh logo"/>
			</li>
			<li>
				<img src="<?php echo e(asset('/css/img/frontpage/trustedus/junkers.png')); ?>" alt="Junkers logo"/>
			</li>
			<li>
				<img src="<?php echo e(asset('/css/img/frontpage/trustedus/buderus.png')); ?>" alt="Bosh logo"/>
			</li>
			<li>
				<img src="<?php echo e(asset('/css/img/frontpage/trustedus/euroforum.png')); ?>" alt="Euroforum logo"/>
			</li>
		</ul>
	</div>
...
<div class="row-fluid col-lg-12 page-container margintop60">
			...
			<div class="clearfix"></div>
			   ...
			   <div class="clearfix"></div>
			   	...
			   	<a href="<?php echo e(url('/ouroffer#offercloud')); ?>">
					<div class="col-sm-6 col-md-4 frontpage-icon-block">
						<div class="thumbnail frontpage-thumbnail">
							<img src="<?php echo e(asset('css/img/frontpage/svg/bar_graph.svg')); ?>" />
						</div>
						<div class="caption text-center">
			   	...
			   	<a href="<?php echo e(url('/ouroffer#offeranalytics')); ?>">
					<div class="col-sm-6 col-md-4 frontpage-icon-block">
						<div class="thumbnail frontpage-thumbnail">
							<img src="<?php echo e(asset('css/img/frontpage/svg/friends.svg')); ?>" />
						</div>
						<div class="caption text-center">
			   	...
			   	<a href="<?php echo e(url('/ouroffer#offergroupwork')); ?>">
					<div class="col-sm-6 col-md-4 frontpage-icon-block">
						<div class="thumbnail frontpage-thumbnail">
							<img src="<?php echo e(asset('css/img/frontpage/svg/download.svg')); ?>" />
						</div>
						<div class="caption text-center">
			   	...
			   	<a href="<?php echo e(url('/ouroffer#offerpsd')); ?>">
					<div class="col-sm-6 col-md-4 frontpage-icon-block">
						<div class="thumbnail frontpage-thumbnail">
							<img src="<?php echo e(asset('css/img/frontpage/svg/student.svg')); ?>" />
						</div>
						<div class="caption text-center">
			   	...
			   	<a href="<?php echo e(url('/ouroffer#offerscorm')); ?>">
					<div class="col-sm-6 col-md-4 frontpage-icon-block">
						<div class="thumbnail frontpage-thumbnail">
							<img src="<?php echo e(asset('css/img/frontpage/svg/questions.svg')); ?>" />
						</div>
						<div class="caption text-center">
			   	...
			   	<a href="<?php echo e(url('/ouroffer#offerquestions')); ?>">
					<div class="col-sm-6 col-md-4 frontpage-icon-block">
						<div class="thumbnail frontpage-thumbnail">
							<img src="<?php echo e(asset('css/img/frontpage/svg/box.svg')); ?>" />
						</div>
						<div class="caption text-center">
			   	...
			   	<a href="<?php echo e(url('/ouroffer#offermailing')); ?>">
					<div class="col-sm-6 col-md-4 frontpage-icon-block">
						<div class="thumbnail frontpage-thumbnail">
							<img src="<?php echo e(asset('css/img/frontpage/svg/camera.svg')); ?>" />
						</div>
						<div class="caption text-center">
			   	...
			   	<a href="<?php echo e(url('/ouroffer#offerlibrary')); ?>">
					<div class="col-sm-6 col-md-4 frontpage-icon-block">
						<div class="thumbnail frontpage-thumbnail">
							<img src="<?php echo e(asset('css/img/frontpage/svg/globe.svg')); ?>" />
						</div>
						<div class="caption text-center">
...
<script src="<?php echo e(asset('js/modules/frontpage.js')); ?>"></script>
<script src="<?php echo e(asset('js/modules/topmenu.js')); ?>"></script>
<?php $__env->stopSection(); ?>
