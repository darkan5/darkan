<?php $__env->startSection('contentlms'); ?>
    ...
    ?>
    <script src="<?php echo e(asset('/js/lms/publication.js')); ?>"></script>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <img style="border: 1px solid black; width: 200px;" src="<?php echo e(($course->thumb != 'none') ? $course->thumb : asset('/css/img/play_button.png')); ?> ">
                </div>

                <div class="col-md-10">
                    <h3>Nazwa: <?php echo e($course->name); ?></h3>
                    <div>Opis: <?php echo e($course->summary); ?></div>
                    <div>Utworzona: <?php echo e($course->date_create); ?></div>
                    <div>Modyfikowana: <?php echo e($course->modified); ?></div>
                    <div>Rozmiar: <?php echo e(round($course->size_project / 1024 / 1024, 2)); ?> Mb</div>
                    <div>

                        <span>Wymagania:</span>


                        <?php if(isset($requirements->pages) && $requirements->pages == true): ?>

                            <i class="fa fa-file-o fa-fw"></i>  <?= Lang::get('darkanpanel.table_column_requirements_pages') ?>

                        <?php endif; ?>

                        <?php if(isset($requirements->score) && $requirements->score == true): ?>
                        ...
                        <?php if((!isset($requirements->pages) || $requirements->pages == false) && (!isset($requirements->score) || $requirements->score == false)): ?>
            ...
            <div class="btn btn-default" title="<?php echo e($course->summary); ?>">
                <img style="border: 1px solid black; width: 20px;" src="<?php echo e(($course->thumb != 'none') ? $course->thumb : asset('/css/img/play_button.png')); ?> ">
                <a href="<?php echo e(url('lms/publication') . '/' . $course->id_banner); ?>" class="btn btn-info btn-xs"><?php echo e($course->name); ?></a>
                <button class="btn btn-success btn-xs edit-publication" id_banner="<?php echo e($course->id_banner); ?>" name="<?php echo e($course->name); ?>" summary="<?php echo e($course->summary); ?>" data-toggle="modal" data-target="#edit-publication-window">E</button>
                <button class="btn btn-danger btn-xs delete-publication" id_banner="<?php echo e($course->id_banner); ?>" data-toggle="modal" data-target="#delete-publication-window">X</button>
                <a href="<?php echo e(url('content', $course->path)); ?>" target="_blank" class="btn btn-success btn-xs" id="open-course-preview"><i class="fa fa-play"></i> <?=Lang::get('darkanpanel.open_course')?></a>
            </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="btn btn-default">
                ...
                ?>
                <img  style="height:20px; border:1px solid black;" src="<?php echo e(asset('/css/img/projects_logos/project_' . $project->editor_id . '.png')); ?>" >
                <a href="<?php echo e(url('lms/project', $project->project_id)); ?>" class="btn btn-default btn-xs"><?php echo e($project->name); ?></a>
                <a href="<?php echo e(url('editor', $project->project_id)); ?>" class="btn btn-success btn-xs"><i class="fa fa-play"></i>Otwórz projekt</a>
            </div>
    ...
    <div class="panel panel-primary">
        ...
        <!-- /.panel-heading -->
        <div class="panel-body">
            <?php if($course->groupContents): ?>

                <?php $__currentLoopData = $course->groupContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupContent): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    ...
                    <div class="btn btn-default">
                        <a class="btn btn-primary btn-xs" href="<?php echo e(url('/lms/elearning/group') . '/' . $group->id); ?>"><?php echo e($group->name); ?></a>


                        <?php if($group->groupUsers): ?>

                            <?php $__currentLoopData = $group->groupUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupUser): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        ...
                        <button class="btn btn-danger btn-xs delete-course-from-group" group_id="<?php echo e($group->id); ?>" content_id="<?php echo e($course->id_banner); ?>" data-toggle="modal" data-target="#delete-course-from-group-window">X</button>
                    </div>

                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>

                <button class="btn btn-success add-course-to-group" content_id="<?php echo e($course->id_banner); ?>" data-toggle="modal" data-target="#add-course-to-group-window">+</button>
                <a href="<?php echo e(url('lms/elearning/groups')); ?>" class="btn btn-success">Dodaj nową grupę</a>
            <?php endif; ?>
        </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <a href="<?php echo e(url('lms/elearning/mailing', $course->id_banner)); ?>" class="btn btn-success">Roześlij emaile</a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="btn btn-default">
                                ...
                                <a class="btn btn-warning btn-xs" href="<?php echo e(url('/lms/elearning/user/') . '/' . $user->id); ?>"> <?php echo e($user->name); ?> ( <?php echo e($user->email); ?>)</a>
                            </div>
                        ...
                        <td>
                            ...
                            <?php if($user->course_status == 'incomplete'): ?>
                                <i style="color:#CDB332" class="fa fa-play-circle fa-fw"></i>  <?=Lang::get('darkanpanel.course_status_incomplete') ?>
                            <?php endif; ?>

                            <?php if($user->course_status == 'passed'): ?>
                                <i style="color:green" class="fa fa-check-circle fa-fw"></i>  <?=Lang::get('darkanpanel.course_status_passed') ?>
                            <?php endif; ?>

                            <?php if($user->course_status == 'failed'): ?>
                                <i style="color:red" class="fa fa-times-circle fa-fw"></i>  <?=Lang::get('darkanpanel.course_status_failed') ?>
                            <?php endif; ?>

                        </td>
                        <td><?php echo e($user->user_score); ?>/<?php echo e($user->score_max); ?> (<?= Lang::get('darkanpanel.score-required')?> <?php echo e(isset($requirements->scoreRequired) ? $requirements->scoreRequired : ''); ?> )</td>
                        <td><?php echo e($user->modify_date); ?></td>
                        <td>

                            <button class="btn btn-danger delete-user-scorm-data" data-toggle="modal" data-target="#delete-user-scorm-data-window"
                                    scorm_data_id="<?php echo e($user->scorm_data_id); ?>">
                                Usuń podejście
                            </button>

                            <a class="btn btn-primary" href="<?php echo e(url('/lms/publication/userscore/') . '/' . $user->id . '/' . $course->id_banner); ?>">Pokaż wyniki</a>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <i class="fa fa-bar-chart-o fa-fw"></i> Analityka kursu
        </div>
        <div class="panel-body">
    ...
    <div class="modal fade" id="delete-user-scorm-data-window" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::hidden('scorm_data_id', null); ?>
    ...
    <div class="modal fade" id="add-course-to-group-window" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::open(array('class' => 'form', 'method' => 'post', 'url' => 'lms/publicationaddcoursetogroup')); ?>

                <?php echo Form::hidden('content_id', $course->id_banner); ?>
    ...
    <div class="modal fade" id="delete-course-from-group-window" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::open(array('class' => 'form', 'method' => 'delete', 'url' => 'lms/publicationdeletegroup')); ?>

                <?php echo Form::hidden('group_id', null); ?>
    ...
    <div class="modal fade" id="edit-publication-window" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::open(array('class' => 'form', 'method' => 'put', 'url' => 'lms/publicationedit')); ?>

                <?php echo Form::hidden('id_banner', null); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <?php echo Form::label('Opis'); ?>

                        <?php echo Form::textarea('summary', null,
                            array(
                                  'class'=>'form-control',
                                  'placeholder'=>'Opis')); ?>
    ...
    <div class="modal fade" id="delete-publication-window" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo Form::open(array('class' => 'form', 'method' => 'delete', 'url' => 'lms/publicationdelete')); ?>
