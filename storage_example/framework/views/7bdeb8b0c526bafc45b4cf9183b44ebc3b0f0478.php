...
<head>
    ...
    <link href="<?php echo e(asset('/css/price.css')); ?>" rel="stylesheet">

    <link href="<?php echo e(asset('/css/bootstrap/bootstrap-select.min.css')); ?>" rel="stylesheet">
    ...
    <script src="<?php echo e(asset('/js/bootstrap/bootstrap-select.min.js')); ?>"></script>
    ...
    <nav class="navbar topmenu navbar-default navbar-fixed-top scrolled">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <!-- Branding Image -->
                <a class="navbar-brand navbar-brand-extend" href="<?php echo e(url('/')); ?>">
                    <img class="logo-top" src="<?php echo e(asset('/css/img/new_web/logo_white.png')); ?>">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <?php if(Auth::user()): ?>
                        ...
                        <?php if(Auth::user()->hasRole('admin') || Session::get('isAdmin')): ?>
                            <li><a href="<?php echo e(url('admin/adminpanel')); ?>">Panel administratora</a></li>
                        <?php endif; ?>

                        <?php if(Auth::user()->hasRole('owner') || Session::get('isOwner')): ?>
                            <li><a href="<?php echo e(url('owner/ownerpanel')); ?>">Panel właściciela</a></li>
                        <?php endif; ?>

                        <?php if(Auth::user() && Auth::user()->hasRole('partner')): ?>
                            <li><a href="<?php echo e(url('partner/sale')); ?>" >Sprzedaż</a></li>
                        <?php endif; ?>

                        <?php if(Auth::user() && Auth::user()->hasRole('distributor') || Session::get('isDistributor')): ?>
                            <li><a href="<?php echo e(url('distributor/adminpanel')); ?>" >Panel dystrybutora</a></li>
                        <?php endif; ?>

                        <?php if(Auth::user() && Auth::user()->hasRole('reseler')): ?>
                            <li><a href="<?php echo e(url('reseler/reselerpanel')); ?>" >Panel reselera</a></li>
                        <?php endif; ?>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="yt-link">
                        <a href="<?php echo e(Lang::get('frontpage.youtubelink')); ?>" target="_blank">
                    ...
                    <li><a href="<?php echo e(url('/home')); ?>"><i class="fa fa-home fa-2x home-icon"></i></a></li>
                    <li><a href="<?php echo e(url('/examples')); ?>"><?= Lang::get('frontpage.examples') ?></a></li>
                    <li><a href="<?php echo e(url('/pricelist')); ?>"><?= Lang::get('frontpage.pricing') ?></a></li>

                    <?php if(Auth::user()): ?>
                        <li><a class="text-bold" href="<?php echo e(url('/projects')); ?>"><?= Lang::get('frontpage.projects') ?></a></li>
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a class="subdomain-link" href="<?php echo e(config('app.protocol_not_secure')); ?><?php echo e(Auth::user()->subdomain); ?>.<?php echo e(config('app.domain')); ?><?php echo e(config('app.folder')); ?>subdomain/login">
                    ...
                    <?php if(Auth::guest()): ?>
                        <li><a href="<?php echo e(url('/login')); ?>"><?=Lang::get('login.loginBtn')?></a></li>
                        <li><a href="<?php echo e(url('/register')); ?>"><?=Lang::get('login.registerButton')?></a></li>
                    <?php else: ?>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <?php if(Session::get('isAdmin')): ?>
                                    <li class="role-user-is-admin"><a href="<?php echo e(url('/admin/loginasadmin/')); ?>">Zaloguj się jako administrator</a></li>
                                <?php endif; ?>

                                <?php if(Session::get('isOwner')): ?>
                                    <li class="role-user-is-admin"><a href="<?php echo e(url('/owner/loginas/')); ?>/<?php echo e(Session::get('loginasid')); ?>">Zaloguj się jako właściciel</a></li>
                                <?php endif; ?>

                                <?php if(Session::get('isDistributor')): ?>
                                    <li class="role-user-is-admin"><a href="<?php echo e(url('/distributor/loginasdistributor/')); ?>">Zaloguj się jako dystrybutor</a></li>
                                <?php endif; ?>

                                <?php if(Session::get('isReseler')): ?>
                                    <li class="role-user-is-admin"><a href="<?php echo e(url('/reseler/loginasreseler/')); ?>">Zaloguj się jako reseler</a></li>
                                <?php endif; ?>
                                ...
                                <li>
                                    <a href="<?php echo e(url('/affiliate')); ?>">
                    ...
                    <?php endif; ?>
                        ...
                        <li class="hideonmobile">
                            ...
                            <ul class="language-menu dropdown-menu" role="menu">
                                <li>
                                    <a href="<?php echo e(url('/changelang/pl')); ?>">
                                        <span class="lang-lg" lang="pl"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('/changelang/en')); ?>">
    ...
    <div class="footer">
        <div class="col-md-offset-1">
            ...
            <div class="col-md-3 col-sm-4">
                    ...
                    <p>
                        <a href="<?php echo e(url('/aboutus')); ?>"><?= Lang::get('frontpage.aboutUs') ?></a>
                    </p>
                    <p>
                        <a href="<?php echo e(url('/aboutproduct')); ?>"><?= Lang::get('frontpage.product') ?></a>
                    </p>
                    <p>
                        <a  href="<?php echo e(url('/productvision')); ?>"><?= Lang::get('frontpage.productVision') ?></a>
                    </p>
                    <p>
            ...
            <div class="col-md-3 col-sm-4">
                    ...
                    <p>
                        <a href="<?php echo e(url('/apidemo')); ?>">
                            <?= Lang::get('frontpage.apidemo') ?>
                        </a>
                    </p>
                    <p>
                        <a href="<?php echo e(url('/apidocs')); ?>">
            ...
            <div class="col-md-3 col-sm-4">
                    ...
                    <?php if(Auth::check() && Auth::user()->hasRole('affiliate')): ?>
                    <p>
                        <a href="<?php echo e(url('/affiliate')); ?>"><?= Lang::get('frontpage.makeMoneyWithUs') ?></a>
                    </p>
                    <?php endif; ?>
            </div>
