...
<html>
<head>
	<title><?php echo e($projectName); ?> - Darkan</title>
	<meta charset="utf-8">
	
	<meta name="_token" content="<?php echo e(csrf_token()); ?>">

    <meta property="og:url" content="<?php echo e(config('app.protocol')); ?><?php echo e(config('app.domain')); ?><?php echo e(config('app.folder')); ?>editor/<?= $projectID ?>" />
    <meta property="og:title" content="<?php echo e($projectName); ?> - Darkan" />
...
// (function(d, debug){var js, id = 'facebook-jssdk', ref = d.getElementsByTagName('script')[0];if   (d.getElementById(id)) {return;}js = d.createElement('script'); js.id = id; js.async = true;js.src = "//connect.facebook.net/en_US/all" + (debug ? "/debug" : "") + ".js";ref.parentNode.insertBefore(js, ref);}(document, /*debug*/ false));
    ...
    <!--[if !IE]><!--><link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/content_template/css/fonts.css')); ?>?r=<?php echo config('app.version') ?>" /><!--<![endif]-->
    <!--[if IE]><!--><link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/content_template/css/fonts_ie.css')); ?>?r=<?php echo config('app.version') ?>" /><!--<![endif]-->
	...
	<!-- <link rel="stylesheet" href="libs/jquery/jqueryui_styles.css?r=<?php //echo config('app.version') ?>" /> -->
   	...
   	<!-- <link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/yui.css')); ?>?r=<?php //echo config('app.version') ?>" /> -->
   	<?php //else: ?>
...
<body class="darkan-content">
	...
	<div id="unexpected-error-modal" class="animated">
		<figure>
			<img src="<?php echo e(asset('/js/editors/standard/images/unexpected_error.png')); ?>" alt="Unexpected Error">
	...
	<div id="load-project-modal" class="animated">
		<figure>
			<img src="<?php echo e(asset('/js/editors/standard/img/social_logos/155x100.png')); ?>" alt="Darkan logo">
   ...
   <script id="history-item-update-page-options-template" type="text/template">
    ...
    <script id="window-function-not-available-testdrive-template" type="text/template"> 
		...
		<div class="window-content test-drive-fn-window-content">
			...
			<p>
				<a target="_blank" href="<?php echo e(url('/auth/register/')); ?>" class="btn signupbutton btn-success">
    ...
    <script id="window-function-not-available-template" type="text/template"> 
		...
		<div class="window-content">
			...
			<p>
				<a target="_blank" href="<?php echo e(url('/pricing/')); ?>" class="btn goprobutton btn-success">
    ...
    <script id="window-share-noexsistuser-template" type="text/template">
		...
		<textarea class="edit-email"><?=Lang::get('editor.SHARE_PROJECT_NOEXIST_POPUP_EMAIL_CONTENT')?> <a href="<?php echo e(url('/auth/register/')); ?>"><?=Lang::get('editor.REGISTER_YOURSELF')?>!</a></textarea>
    </script>
...
// ?????????????????????
	...
	<!-- JQUERY -->
	<script src="<?php echo e(asset('/js/editors/standard/libs/jquery/jq11.js')); ?>?r=<?php echo config('app.version') ?>"></script>
    <script src="<?php echo e(asset('/js/editors/standard/libs/jquery/jqui.js')); ?>?r=<?php echo config('app.version') ?>"></script>

    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/jplayer/jquery.jplayer.min.js')); ?>?r=<?php echo config('app.version') ?>"></script>
	...
	<!-- SWFOBJECT -->
	<script src="<?php echo e(asset('/js/editors/standard/libs/swfobject/jquery.swfobject.1-1-1.min.js')); ?>?r=<?php echo config('app.version') ?>"></script>


	<!-- MD5 -->
	<script src="<?php echo e(asset('/js/editors/standard/libs/md5/md5.js')); ?>?r=<?php echo config('app.version') ?>"></script>

	<!-- CHOSEN SELECT -->
    <link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/chosen/chosen.min.css')); ?>?r=<?php echo config('app.version') ?>" />
    <script src="<?php echo e(asset('/js/editors/standard/libs/chosen/chosen.jquery.min.js')); ?>?r=<?php echo config('app.version') ?>"></script>

    <!-- ROTATABLE -->
    <link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/rotatable/jquery.ui.rotatable.css')); ?>?r=<?php echo config('app.version') ?>" />
    <script src="<?php echo e(asset('/js/editors/standard/libs/rotatable/jquery.ui.rotatable.js')); ?>?r=<?php echo config('app.version') ?>"></script>

	<!-- PERFECT SCROLLBAR -->
	<script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/perfect-scrollbar/js/min/perfect-scrollbar.jquery.min.js')); ?>?r=<?php echo config('app.version') ?>"></script>

    <!-- CKEDITOR -->
    <script src="<?php echo e(asset('/js/editors/standard/libs/ckeditor/ckeditor.js')); ?>?r=<?php echo config('app.version') ?>"></script>


    <!-- PRELOAD JS -->
    <script src="<?php echo e(asset('/js/editors/standard/libs/preload/preload.js')); ?>?r=<?php echo config('app.version') ?>"></script>
    ...
    <!-- MAIN LIBS -->
	<script src="<?php echo e(asset('/js/editors/standard/libs/underscore/underscore.js')); ?>?r=<?php echo config('app.version') ?>"></script>
	<script src="<?php echo e(asset('/js/editors/standard/modules/utils/underscore_extend.js')); ?>?r=<?php echo config('app.version') ?>"></script>
	<script src="<?php echo e(asset('/js/editors/standard/libs/backbone/backbone.js')); ?>?r=<?php echo config('app.version') ?>"></script>
	<script src="<?php echo e(asset('/js/editors/standard/libs/backbone/backbone.stickit.js')); ?>?r=<?php echo config('app.version') ?>"></script>
	<script src="<?php echo e(asset('/js/editors/standard/libs/backbone/backbone.controller.js')); ?>?r=<?php echo config('app.version') ?>"></script>
   	<script src="<?php echo e(asset('/js/editors/standard/server/socket.io/node_modules/socket.io-client/socket.io.js')); ?>"></script>

    <link href="<?php echo e(asset('/js/editors/standard/content_template/js/libs/video-js/video-js.css')); ?>?r=<?php echo config('app.version') ?>" rel="stylesheet" type="text/css">
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/video-js/video.js')); ?>?r=<?php echo config('app.version') ?>"></script>
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/video-js/vjs.youtube.js')); ?>?r=<?php echo config('app.version') ?>"></script>
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/video-js/vjs.vimeo.js')); ?>?r=<?php echo config('app.version') ?>"></script>
	...
	<!-- TAGS INPUT -->
    <link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/tags/tagsinput.css')); ?>?r=<?php echo config('app.version') ?>" />
    <script src="<?php echo e(asset('/js/editors/standard/libs/tags/tagsinput.js')); ?>?r=<?php echo config('app.version') ?>"></script>

    <!-- JS CROP -->
    <link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/jcrop/jquery.Jcrop.min.css')); ?>?r=<?php echo config('app.version') ?>" />
    <script src="<?php echo e(asset('/js/editors/standard/libs/jcrop/jquery.Jcrop.min.js')); ?>?r=<?php echo config('app.version') ?>"></script>

    <!-- SPECTRUM -->
    <link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/spectrum/spectrum.css')); ?>?r=<?php echo config('app.version') ?>" />
    <script src="<?php echo e(asset('/js/editors/standard/libs/spectrum/spectrum.js')); ?>?r=<?php echo config('app.version') ?>"></script>

    <!-- GRADIENT PICKER -->
	<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/gradient-plugin/jquery.gradientPicker.css')); ?>?r=<?php echo config('app.version') ?>" type="text/css" />
	<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/gradient-plugin/css/colorpicker.css')); ?>?r=<?php echo config('app.version') ?>" type="text/css" />
	<script src="<?php echo e(asset('/js/editors/standard/libs/gradient-plugin/js/colorpicker.js')); ?>?r=<?php echo config('app.version') ?>"></script>
	<script src="<?php echo e(asset('/js/editors/standard/libs/gradient-plugin/jquery.gradientPicker.js')); ?>?r=<?php echo config('app.version') ?>"></script>

	<script src="<?php echo e(asset('/js/editors/standard/libs/base64/base64_encoding,js.js')); ?>?r=<?php echo config('app.version') ?>"></script>
	...
	<!-- SUMMERNOTE -->
	<script type="text/javascript" src="<?php echo e(asset('/js/editors/standard/libs/bootstrap/bootstrap.js')); ?>"></script>
	<!-- Custom Fonts -->
    <link href="<?php echo e(asset('/js/editors/standard/css/font-awesome/css/font-awesome.min.css')); ?>" rel="stylesheet" type="text/css">

	<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/summernote/summernote.css')); ?>?r=<?php echo config('app.version') ?>" />
	<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/summernote/snote-bs2.css')); ?>?r=<?php echo config('app.version') ?>" />
	<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/libs/summernote/snote-bs3.css')); ?>?r=<?php echo config('app.version') ?>" />
	...
	<!-- CREATE NEW VARIABLE -->
	<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/modules/windows/create_new_variable/create_new_variable.css')); ?>?r=<?php //echo config('app.version') ?>" />
    ...
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/jsBezier-0.6.js')); ?>"></script>
    <!-- event adapter -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/mottle-0.4.js')); ?>"></script>
    <!-- geom functions -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/biltong-0.2.js')); ?>"></script>
    <!-- jsplumb util -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/util.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/browser-util.js')); ?>"></script>
    <!-- base DOM adapter -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/dom-adapter.js')); ?>"></script>
    <!-- main jsplumb engine -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/jsPlumb.js')); ?>"></script>
    <!-- endpoint -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/endpoint.js')); ?>"></script>
    <!-- connection -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/connection.js')); ?>"></script>
    <!-- anchors -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/anchors.js')); ?>"></script>
    <!-- connectors, endpoint and overlays  -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/defaults.js')); ?>"></script>
    <!-- bezier connectors -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/connectors-bezier.js')); ?>"></script>
    <!-- state machine connectors -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/connectors-statemachine.js')); ?>"></script>
    <!-- flowchart connectors -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/connectors-flowchart.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/connector-editors.js')); ?>"></script>
    <!-- SVG renderer -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/renderers-svg.js')); ?>"></script>
    <!-- vml renderer -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/renderers-vml.js')); ?>"></script>
    <!-- common adapter -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/base-library-adapter.js')); ?>"></script>
    <!-- jquery jsPlumb adapter -->
    <script src="<?php echo e(asset('/js/editors/standard/content_template/js/libs/connectlines/lib/jquery.jsPlumb.js')); ?>"></script>
	...
	<!-- APP INIT -->
   	...
   	<!-- ALL SCRIPTS -->
   	<?php if (env('APP_ENV') == 'production'): ?>
   	<script type="text/javascript" src="<?php echo e(asset('/js/editors/standard/libs/yui.js')); ?>?r=<?php echo config('app.version') ?>"></script>
   	<?php else: ?>
	...
	<script>
		...
		if(Utils.isChrome()){
			...
			var link = $('<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/css/browsers/chrome.css')); ?>?r=<?php echo config('app.version') ?>" />');
			$('head').append(link);
		}
		...
		if(Utils.isFirefox()){
			...
			var link = $('<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/css/browsers/firefox.css')); ?>?r=<?php echo config('app.version') ?>" />');
			$('head').append(link);
		}
		...
		if(Utils.getInternetExplorerVersion() != -1){
			...
			var link = $('<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/css/browsers/ie.css')); ?>?r=<?php echo config('app.version') ?>" />');
			$('head').append(link);
		}
	...
	<!-- RESPONSIVE CSS -->
	<link rel="stylesheet" href="<?php echo e(asset('/js/editors/standard/css/responsive/1366.css')); ?>?r=<?php echo config('app.version') ?>" />
