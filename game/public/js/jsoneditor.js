...
JSONEditor.defaults.editors.base64 = JSONEditor.AbstractEditor.extend({
  ...
  refreshPreview: function() {
    ...
    if(!mime) {
      ...
      this.preview.innerHTML = '<strong>Typ pliku:</strong> '+mime+', <strong>Wielkość:</strong> '+Math.floor((this.value.length-this.value.split(',')[0].length-1)/1.33333)+' bity';
...
JSONEditor.defaults.languages.en = {
   ...
   */
  button_delete_all: "Wszystkie",
  /**
   * Title on Delete All buttons
   */
  button_delete_all_title: "Usuń Wszystkie",
  /**
    * Text on Delete Last buttons
    * @variable This key takes one variable: The title of object to delete
    */
  button_delete_last: "Ostatnie {{0}}",
  /**
    * Title on Delete Last buttons
    * @variable This key takes one variable: The title of object to delete
    */
  button_delete_last_title: "Usuń ostatnie {{0}}",
  /**
    * Title on Add Row buttons
    * @variable This key takes one variable: The title of object to add
    */
  button_add_row_title: "Dodaj {{0}}",
  /**
